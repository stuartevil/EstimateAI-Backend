...
from app.shared.pagination import PaginatedData
...
async def list_projects(
    ...
    projects, total = await service.list_projects(owner_id=current_user.id, skip=skip, limit=page_size)
...
async def update_project(
    ...
    project = await service.update_project(project_id, payload, owner_id=current_user.id)
