...
Stores visual annotations on PDF pages (highlights, lines, text, etc.)
similar to Bluebeam Revu markup tools.
"""
...
class Markup(Base):
    ...
    # Style and geometry stored as JSON for flexibility (color, stroke, points, etc.)
