...
Stores quantity takeoff measurements on construction drawings
(length, area, count, volume) — core data for estimation.
"""
...
class Measurement(Base):
    """Takeoff measurement on a project drawing."""
    ...
    # GeoJSON-like coordinates for the measurement geometry on the page
