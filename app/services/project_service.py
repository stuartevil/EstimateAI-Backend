...
class ProjectService:
    ...
    async def update_project(self, project_id: UUID, data: ProjectUpdate, owner_id: UUID) -> Project:
    ...
    async def list_projects(
        ...
        return (
            await self.repo.list_by_owner(owner_id, skip=skip, limit=limit),
            await self.repo.count_by_owner(owner_id),
        )
